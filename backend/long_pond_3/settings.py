"""
Django settings for long_pond_3 project.
...
WSGI_APPLICATION = 'long_pond_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "long_pond_3 API",
    "DESCRIPTION": "API documentation for long_pond_3 App",
    "VERSION": "v1",
}
